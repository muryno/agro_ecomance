...
class Wishe {
    ...
    Wishe({this.parentUuid,this.weight,this.name, this.thumbnail_url,this.file_url, this.created_at, this.discounted_price, this.id, this.price, this.product, this.product_id, this.quantity, this.updated_at, this.user_id, this.uuid});
